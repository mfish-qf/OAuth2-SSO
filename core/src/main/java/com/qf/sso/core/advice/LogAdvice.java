...
import com.qf.sso.core.dao.SSOLogDao;
...
public class LogAdvice {
    ...
    @Before("@annotation(com.qf.sso.core.annotation.LogAnnotation)")
    ...
    @AfterReturning(value = "@annotation(com.qf.sso.core.annotation.LogAnnotation)", returning = "returnValue")
    public void doAfterReturning(Object returnValue) {
        setReturn(0, JSON.toJSONString(returnValue));
    }

    @AfterThrowing(value = "@annotation(com.qf.sso.core.annotation.LogAnnotation)", throwing = "e")
